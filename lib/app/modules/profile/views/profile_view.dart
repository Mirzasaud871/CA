...
import 'package:vakil99/app/modules/document/controllers/document_controller.dart';
                  ...
                  child: Row(
                    children: [
                      ...
                      IconButton(
                          ...
                          icon: Icon(Icons.settings, size: width * 0.10,))
                      // SizedBox(
                      //   height: 50,
                            ...
                            children: [
                              ...
                              Row(
                                children: [
                                  ...
                                  Obx(() {
                                    return Text(
                                      '${familymemberController.familyListModel
                                          .length}',
                                      style: TextStyle(
                                          color: Colors.white,
                                          fontSize: width * 0.07,
                            ...
                            children: [
                              ...
                              Row(
                                children: [
                                  ...
                                  Obx(() {
                                    return Text(
                                      '${myorderController.myOrderlistModel
                                          .length}',
                                      style: TextStyle(
                                          color: Colors.white,
                                          fontSize: width * 0.07,
                            ...
                            children: [
                              ...
                              Row(
                                children: [
                                  ...
                                  Obx(() {
                                    return Text(
                                      '${documentController.documentListModel
                                          .length}',
                                      style: TextStyle(
                                          color: Colors.white,
                                          fontSize: width * 0.07,
